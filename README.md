...
> ABUAD HMS is a web-based application that allows the efficient management of hostels in Afe Babalola University. The system simplifies the process of hostel allocation, room management, and billing.
